...
strategies = {
    ...
    "single_domain_double_shot": (setupSqlScript +
                   ...
                   " \nSELECT DISTINCT r.first_name, r.last_name, race.name AS race_name, race.distance\n FROM runner r\n JOIN registration reg ON r.id = reg.runner_id\n " +
                   "JOIN race race ON reg.race_id = race.id\n WHERE race.distance = 26.20; " +
                   commonSqlOnlyRequest)
}

questions = [
    "Who is the fastest runner?",
    "What shoe would you recommend based off of race time?",
    "What shoe would you recommend based off of prize money won?",
    "Which race has the most prize money?",
    "Which races are located in Provo?",
    "Has a woman ever beat a man?",
    "Which runner had to travel the furthest for a race?",
]
...
for strategy in strategies:
    ...
    for question in questions:
        ...
        try:
            ...
            # friendlyResultsPrompt = "I asked a question \"" + question +"\" and the response was \""+queryRawResponse+"\" Please give a concise response in a friendly way. Please do not give any other suggestions or chatter."
            ...
            bestResponse = "I asked: \"" + question + "\".\n The result was: \"" + queryRawResponse + "\".\n Could you concisely answer my question using this data? Please be brief."
            bestResponse = getChatGptResponse(bestResponse)
            print("Response:")
            print(bestResponse)
